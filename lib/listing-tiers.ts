...
export const LISTING_TIERS: Record<string, ListingTier> = {
  basico: {
    ...
    featuredDays: 0,
    badge: null,
    features: ["Anuncio visivel durante 15 dias", "Ate 5 fotografias", "Posicionamento standard"],
  },
  standard: {
    id: "standard",
    name: "Standard",
    ...
    featuredDays: 0,
    badge: null,
    features: ["Anuncio visivel durante 30 dias", "Ate 10 fotografias", "Posicionamento standard"],
  },
  destaque: {
    id: "destaque",
    name: "Destaque",
