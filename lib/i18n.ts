...
const seoMetadata: Record<Locale, {
  ...
  pt: {
    ...
    siteDescription: "Marketplace premium de cavalos Lusitanos. Loja equestre, coudelarias certificadas e o maior arquivo editorial sobre o cavalo Português.",
    ogLocale: "pt_PT",
  ...
  en: {
    ...
    siteDescription: "Premium Lusitano horse marketplace. Equestrian shop, certified stud farms and the largest editorial archive about the Portuguese horse.",
    ogLocale: "en_US",
    keywords: ["lusitano horse", "portuguese horses", "equestrian", "dressage", "stud farm", "PRE", "iberian horse", "buy horse", "equestrian portugal"],
  },
};
