...
(
  ...
  'O projecto Cavalos na Areia começou na Comporta e foi fundado por José Ribeira em 2011. Para alguém que praticamente cresceu numa sela e começou a montar a cavalo aos 3 anos, o turismo equestre foi a concretização de um sonho.
...
— Guided by Sand (Comporta): o percurso original, ao longo dos arrozais, atravessando o pinhal e as dunas até à praia — um trecho paradisíaco da costa atlântica praticamente deserto.

— Guided by Land (Serra da Arrábida): na Quinta do Esteval, propriedade da família Palmela desde o séc. XVIII, dentro do Parque Natural da Arrábida, atravessando paisagens agrícolas e zonas selvagens.

— Guided by Water (Rio Sado, Alcácer do Sal): uma combinação de passeio a cavalo e canoagem pelo Rio Sado, partindo da Herdade de Porches junto a Alcácer do Sal.

— Guided by Nature (2 dias): experiência completa que une praia, rio e serra — inclui almoço na Comporta, kayak no Rio Sado, noite no Hotel Casa Palmela em Setúbal, e cavalgada na Serra da Arrábida.

Para além dos passeios, oferece aulas de equitação, aluguer de boxes, organização de eventos especiais, sessões fotográficas profissionais com drone, e vouchers de oferta personalizados.',
  'Torre, Comporta',
  'Alentejo',
  '+351 913 181 844',
  ...
  '@cavalosnaareia',
  'https://www.facebook.com/Cavalosnaareia/',
  NULL,
  70,
  2011,
  ARRAY['Turismo Equestre', 'Passeios a Cavalo', 'Aulas de Equitação', 'Responsabilidade Ambiental'],
  NULL,
  ARRAY[
    'Melhor Empresa de Animação Turística 2017 — Turismo do Alentejo',
    'Prémio Mais Sensação — Óscares do Alentejo'
  ],
  ARRAY['Passeios a cavalo na praia', 'Passeios na Serra da Arrábida', 'Passeios pelo Rio Sado com kayak', 'Experiência de 2 dias', 'Aulas de equitação', 'Aluguer de boxes', 'Eventos especiais', 'Sessões fotográficas e drone', 'Vouchers de oferta'],
  38.3847,
  -8.7875,
  'Segunda a Domingo. Verão (Jun-Set): 08:00, 09:30, 11:00, 17:00 (cavalos descansam 12:30-16:30). Inverno (Out-Mai): 11:00, 15:00. Reservas com 48h de antecedência.',
  '/images/coudelarias/cavalos-na-areia/capa.jpg',
  ARRAY[
    '/images/coudelarias/cavalos-na-areia/galeria-1.jpg'
  ],
  NULL,
  '[]'::jsonb,
  '[]'::jsonb,
  ARRAY['comporta', 'turismo equestre', 'praia', 'passeios a cavalo', 'arrozais', 'reserva natural', 'alentejo', 'serra arrabida', 'alcacer do sal', 'rio sado', 'kayak', 'drone', 'vouchers', 'setubal'],
  false,
  false,
  0,
  'active',
...
-- FONTE: https://lusitanosdatela.com/
-- FONTE: https://www.visitportugal.com/en/content/lusitanos-datela-coudelaria-bessa-de-carvalho
-- FONTE: https://www.visitribatejo.pt/en/catalogue/what-to-do/tourist-activities/lusitanos-d-atela/
-- FONTE: https://www.eurodressage.com/2025/09/12/carlos-pintos-soberano-passed-away (Soberano WEG 2014)
-- FONTE: https://www.eurodressage.com/2021/04/01/hercules-datela-receives-4-recommendation-portuguese-lusitano-studbook
-- FONTE: https://www.fei.org/horse/104PV85 (Xenofonte d'Atela WEG 2018)
-- FONTE: https://www.equisport.pt/noticias/feira-anual-da-trofa-2019-oeste-datela-eleito-campeao-macho-e-campeao-de-campeoes/
-- FONTE: https://www.mediotejo.net/golega-lenda-datela-e-horta-do-loyal-vencem-expoegua-2018/
-- FONTE: https://www.cavalo-lusitano.com/pt/noticias/resultados-2-salao-do-cavalo-lusitano-2025
-- VERIFICADO: 2026-02-22
-- =============================================
(
  'Lusitanos d''Atela',
  'lusitanos-datela',
  'Coudelaria familiar do Ribatejo fundada em 1989 por Francisco Bessa de Carvalho, Mestre-Picador da Escola Portuguesa de Arte Equestre. Referência nacional na criação e selecção do Puro-Sangue Lusitano, com cavalos em 5 continentes e presença nos Jogos Olímpicos e nos WEG.',
...
Para além da coudelaria principal em Alpiarça, a família Bessa de Carvalho tem também um centro de treino equestre em Caneças (Odivelas), a 12 km de Lisboa, onde oferece aulas de equitação. A coudelaria recebe visitas e organiza passeios a cavalo pela paisagem ribatejana.',
  ...
  NULL,
  '[
    {"nome": "Soberano", "ano": 1999, "pelagem": "Tordilho", "aptidao": "Dressage Grand Prix / WEG 2014", "vendido": false, "nota": "Falecido em 2025. 193 descendentes registados. FONTE: eurodressage.com/2025/09/12/carlos-pintos-soberano-passed-away"},
    {"nome": "Hercules d''Atela", "ano": 2013, "pelagem": "Cinzento", "aptidao": "Modelo — Campeão Europeu Criação Lusitana 2016", "vendido": true, "nota": "Aprovação 4 estrelas APSL. FONTE: eurodressage.com/2021/04/01/hercules-datela-receives-4-recommendation"},
    {"nome": "Xenofonte d''Atela", "ano": 2003, "pelagem": "Tordilho", "aptidao": "Dressage Grand Prix / WEG 2018", "vendido": true, "nota": "FONTE: fei.org/horse/104PV85"},
