        ...
        <div className="relative pl-6 sm:pl-8 border-l-2 border-[#C5A059]/30">
          ...
          <div className="bg-zinc-800/40 border border-zinc-700/30 rounded-xl p-5 sm:p-6">
            ...
            <p className="text-[13px] text-zinc-400 leading-relaxed">
              ...
              <strong className="text-white">Hong Kong</strong>, devido a preocupações gerais com
              doenças equinas na China continental, incluindo a piroplasmose. Hong Kong foi
              seleccionada pela sua infraestrutura de corridas, herdada da era colonial britânica,
