...
export default function GenealogyTree({ horse }: GenealogyTreeProps) {
  return (
    <div className="w-full bg-zinc-950/50 p-12 border border-zinc-900 overflow-x-auto">
      <h3 className="text-[#C5A059] text-[10px] uppercase tracking-[0.5em] font-bold mb-16 text-center">
      ...
      <div className="flex justify-center items-center gap-8 min-w-[800px]">
        ...
        <div className="flex flex-col gap-4">
          {[1, 2, 3, 4].map((i) => (
            <div
              key={i}
              className="w-48 border border-zinc-900 p-3 opacity-60 hover:opacity-100 transition-all"
            >
