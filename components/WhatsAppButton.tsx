  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-36 lg:bottom-6 right-6 z-50 w-14 h-14 bg-[#25D366] rounded-full shadow-lg flex items-center justify-center hover:bg-[#20bd5a] hover:scale-110 active:scale-95 transition-all duration-300 group opacity-0 animate-[fadeSlideIn_0.5s_ease-out_1s_forwards]"
        aria-label={
          isOpen
      ...
      {/* Chat Widget */}
      {isOpen && (
        <div className="fixed bottom-52 lg:bottom-24 right-6 z-50 w-80 bg-[var(--background-card)] rounded-2xl shadow-2xl overflow-hidden opacity-0 animate-[scaleIn_0.3s_ease-out_forwards] border border-[var(--border)]">
          {/* Header */}
