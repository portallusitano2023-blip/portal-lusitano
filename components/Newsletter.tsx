    ...
    <section className="bg-[#0a0a0a] border-y border-gray-900 py-16 px-6">
      <div className="max-w-4xl mx-auto text-center">
        ...
        {status === 'success' ? (
          ...
          <form onSubmit={handleSubmit} className="flex flex-col md:flex-row gap-4 justify-center" aria-label="Subscrição da newsletter">
            <label htmlFor="newsletter-email" className="sr-only">O seu e-mail</label>
            <input
              id="newsletter-email"
              type="email"
