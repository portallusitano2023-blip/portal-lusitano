...
const plans = [
  {
    ...
    popular: false,
    features: [
      { text: "Acesso a 5 Ebooks exclusivos", included: true },
      { text: "Newsletter semanal premium", included: true },
      { text: "Comunidade privada", included: true },
      { text: "Desconto 10% na loja", included: true },
      { text: "Cursos em vídeo", included: false },
      { text: "Consultoria personalizada", included: false },
      { text: "Certificações", included: false },
    ],
  },
  {
    id: "criador",
    ...
    features: [
      ...
      { text: "Biblioteca completa de Ebooks", included: true },
      { text: "Cursos em vídeo ilimitados", included: true },
      { text: "Templates e ferramentas", included: true },
      { text: "Webinars mensais ao vivo", included: true },
      { text: "Certificações oficiais", included: true },
      { text: "Consultoria 1x/mês", included: false },
    ],
  },
  {
    id: "elite",
    ...
    features: [
      ...
      { text: "Consultoria ilimitada", included: true },
      { text: "Acesso antecipado a cavalos", included: true },
      { text: "Networking com criadores", included: true },
      { text: "Visitas a coudelarias VIP", included: true },
...
const features = [
  {
    ...
    description: "Guias completos sobre criação, linhagens, treino e muito mais",
  },
  {
    icon: Video,
    title: "Cursos em Vídeo",
    description: "Masterclasses com campeões e especialistas de renome",
  },
  {
    icon: GraduationCap,
    title: "Certificações",
    description: "Diplomas reconhecidos para valorizar o teu currículo",
  },
  {
    icon: Users,
