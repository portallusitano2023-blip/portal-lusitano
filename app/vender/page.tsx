...
const UploadZone = ({ label, icon }) => (
  <div className="border border-dashed border-zinc-800 bg-zinc-900/50 p-8 text-center hover:border-[#C5A059] hover:bg-zinc-900 transition-all cursor-pointer group">
    <div className="text-2xl mb-3 text-zinc-600 group-hover:text-[#C5A059] transition-colors">{icon}</div>
      ...
      <main className="min-h-screen bg-black text-white pt-32 pb-20 px-6">
        ...
        <header className="max-w-4xl mx-auto mb-12 text-center">
          <div className="inline-flex items-center gap-2 border border-zinc-800 px-4 py-2 rounded-full mb-6">
            ...
            <span className="text-[9px] uppercase tracking-widest text-zinc-400">Ambiente Seguro • SSL Encriptado</span>
          </div>
          ...
          <p className="text-zinc-500 font-light text-sm max-w-xl mx-auto">
            Para garantir a integridade do Portal Lusitano, exigimos dados completos de cada exemplar. O seu cavalo será submetido a uma <strong>auditoria técnica</strong> antes de ficar online.
          </p>
        </header>
            ...
            {steps.map((step) => (
              <div key={step.id} className="flex flex-col items-center gap-4 bg-black px-4">
                ...
                <div className="text-center hidden md:block">
                  <p className={`text-[9px] uppercase tracking-widest font-bold ${currentStep >= step.id ? 'text-white' : 'text-zinc-700'}`}>{step.title}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="max-w-4xl mx-auto bg-zinc-950 border border-zinc-900 p-8 md:p-16 relative">
            ...
            <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-2">
                   <label className="text-[9px] uppercase tracking-widest text-zinc-500">Nome Completo (Livro Azul)</label>
                   <input type="text" className="w-full bg-black border border-zinc-800 p-4 text-white text-sm focus:border-[#C5A059] outline-none" placeholder="Ex: IMPERADOR II" />
                </div>
                <div className="space-y-2">
                   <label className="text-[9px] uppercase tracking-widest text-zinc-500">Nº UELN (Universal Equine Life Number)</label>
                   <input type="text" className="w-full bg-black border border-zinc-800 p-4 text-white text-sm focus:border-[#C5A059] outline-none font-mono" placeholder="724015..." />
                </div>
                <div className="space-y-2">
                   <label className="text-[9px] uppercase tracking-widest text-zinc-500">Nº do Microchip</label>
                   <input type="text" className="w-full bg-black border border-zinc-800 p-4 text-white text-sm focus:border-[#C5A059] outline-none font-mono" placeholder="9811000..." />
                </div>
                <div className="space-y-2">
                   <label className="text-[9px] uppercase tracking-widest text-zinc-500">Data de Nascimento</label>
                   <input type="date" className="w-full bg-black border border-zinc-800 p-4 text-white text-sm focus:border-[#C5A059] outline-none text-zinc-400" />
                </div>
              </div>

              <div className="pt-4">
                <label className="text-[9px] uppercase tracking-widest text-zinc-500 block mb-4">Comprovativo de Propriedade (Obrigatório)</label>
            ...
            <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="bg-red-950/20 border border-red-900/30 p-6 flex gap-4 items-start">
                 ...
                 <p className="text-xs text-red-200/70 leading-relaxed">
                   <strong>Aviso de Transparência:</strong> Omitir lesões ou cirurgias prévias resultará no banimento permanente do vendedor e na retenção da taxa de inscrição.
                 </p>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                 <div className="space-y-4">
                    <p className="text-[10px] uppercase tracking-widest text-zinc-400 font-bold">Exames Disponíveis</p>
                 ...
                 <div className="space-y-4">
                    <p className="text-[10px] uppercase tracking-widest text-zinc-400 font-bold">Vícios e Comportamento</p>
                    <textarea className="w-full h-40 bg-black border border-zinc-800 p-4 text-white text-sm focus:border-[#C5A059] outline-none" placeholder="Descreva honestamente o temperamento (box, transporte, ferrar) e se existe algum vício de estábulo..."></textarea>
                 </div>
              </div>
          ...
          {currentStep === 3 && (
            <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <p className="text-zinc-500 text-sm italic">
                Não aceitamos fotos de telemóvel de baixa qualidade. O seu cavalo será avaliado pelo que mostra aqui.
              </p>
              ...
              <div className="space-y-2 pt-6">
                 <label className="text-[9px] uppercase tracking-widest text-zinc-500">Link de Vídeo (Obrigatório: Passo, Trote, Galope)</label>
                 <input type="url" className="w-full bg-black border border-zinc-800 p-4 text-white text-sm focus:border-[#C5A059] outline-none font-mono" placeholder="https://youtube.com/..." />
              </div>
            </div>
          )}
          ...
          {currentStep === 4 && (
            <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="bg-zinc-900 p-8 text-center space-y-6">
                 ...
                 <h4 className="text-white text-lg font-serif">O cavalo entrará em "Quarentena Digital"</h4>
                 <p className="text-zinc-400 text-sm leading-relaxed max-w-lg mx-auto">
                   Após o pagamento da taxa de listagem (75€), a equipa do Portal Lusitano irá verificar o UELN e o Chip junto da base de dados oficial. 
                   <br/><br/>
              ...
              <div className="flex items-start gap-4 p-4 border border-zinc-800">
                ...
                <p className="text-xs text-zinc-500">
                  Declaro sob compromisso de honra que sou o legítimo proprietário deste animal e autorizo o Portal Lusitano a verificar os dados clínicos junto do médico veterinário indicado.
                </p>
              </div>
            </div>
          )}
          ...
          <div className="flex justify-between mt-12 pt-8 border-t border-zinc-900">
            ...
            {currentStep < 4 ? (
              ...
              <button 
                className="bg-[#C5A059] text-black px-10 py-4 text-[10px] uppercase font-bold tracking-[0.2em] hover:bg-white hover:text-black transition-all shadow-[0_0_20px_rgba(197,160,89,0.3)]"
              >
