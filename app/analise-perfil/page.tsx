...
const results: Record<string, Result> = {
  competidor: {
    ...
    famousHorses: [
      { name: "Rubi AR", achievement: "Jogos Olimpicos Londres 2012 com Gonçalo Carvalho" },
...
function RadarChart({ data }: RadarChartProps) {
  ...
  const pts = labels.map((item, i) => {
    ...
    const v = data[item.key as keyof typeof data] / 100;
...
function AnalisePerfilContent() {
  ...
  const [selectedTab, setSelectedTab] = useState<
    "perfil" | "cavalo" | "custos" | "cronograma" | "analise" | "proximos"
  >("perfil");
  ...
  const scorePercentages = Object.entries(scores)
    .map(([p, s]) => ({
      profile: p,
      ...
      {showIntro ? (
            ...
            <div className="max-w-6xl mx-auto px-6">
              ...
              <div className="grid md:grid-cols-4 gap-8">
                {[
                  ...
                  >
                    <div className="w-14 h-14 mx-auto bg-[#C5A059]/10 rounded-full flex items-center justify-center mb-4">
                      <f.icon className="text-[#C5A059]" size={24} />
                    </div>
        ...
        <div key="result" className="min-h-screen animate-[fadeSlideIn_0.4s_ease-out_forwards]">
          {result && (
            <>
              <section
                className={`relative pt-32 pb-16 bg-gradient-to-b ${result.color} to-transparent`}
              >
                        ...
                        {scorePercentages.map((item, i) => (
                          ...
                          >
                            <div className="flex justify-between text-sm mb-1">
                              <span
                                className={i === 0 ? "text-[#C5A059] font-medium" : "text-zinc-400"}
                              >
                                {item.label}
                              </span>
                              <span
                                className={i === 0 ? "text-[#C5A059] font-bold" : "text-zinc-500"}
                              >
                                {item.percentage}%
                              </span>
                            </div>
              ...
              <section className="py-12">
                <div className="max-w-5xl mx-auto px-6">
                  {selectedTab === "perfil" && (
                    <div
                      key="perfil"
                      className="space-y-8 animate-[fadeSlideIn_0.4s_ease-out_forwards]"
                    >
                      ...
                      <div className="bg-zinc-900/30 border border-white/5 p-8">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {result.disciplinas.map((d) => (
                            <span
                              key={d}
                              className="bg-[#C5A059]/10 text-[#C5A059] px-4 py-2 text-sm"
                            >
                              {d}
                            </span>
                          ))}
                      ...
                      <div className="bg-gradient-to-b from-[#C5A059]/10 to-transparent border border-[#C5A059]/20 p-8">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                          {[
                            ...
                            <div
                              key={it.label}
                              className="bg-zinc-900/50 p-5 border border-white/5"
                            >
                          ...
                          {Object.entries(results).map(([k, r]) => (
                            <div key={k} className="flex items-center gap-4">
                              ...
                              >
                                ...
                                {r.annualCosts.max.toLocaleString()}
                              </div>
                            </div>
                          ))}
                        </div>
                            ...
                            >
                              ...
                              {expandedFaq === i && (
                                <div className="animate-[fadeSlideIn_0.2s_ease-out_forwards]">
                                  <div className="p-4 bg-zinc-900/50 text-zinc-400 text-sm">
                                    {item.answer}
                                  </div>
                                </div>
                              )}
                            ...
                            return (
                              ...
                              >
                                <div className="flex items-start justify-between gap-4 mb-2">
                                  ...
                                  <div
                                    className={`px-2 py-1 text-xs font-medium text-white rounded ${profileColors[maxProfile[0]] || "bg-zinc-600"}`}
                                  >
                                ...
                                <div className="flex gap-1 h-2">
                                  {Object.entries(detail.points).map(([profile, pts]) => (
                                    <div
                                      key={profile}
                                      className={`${profileColors[profile]} opacity-${Math.min(100, pts * 10)}`}
