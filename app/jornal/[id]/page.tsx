...
export default function ArticlePage() {
  ...
  // Seleciona os dados do artigo baseado no idioma atual
    ...
    return (
      <div className="min-h-screen bg-[#050505] flex items-center justify-center text-white">
        <div className="text-center space-y-4">
          ...
          <Link href="/jornal" className="text-[#C5A059] border-b border-[#C5A059] pb-1 uppercase text-xs tracking-widest">{t.journal.back}</Link>
        </div>
      </div>
    );
  }
