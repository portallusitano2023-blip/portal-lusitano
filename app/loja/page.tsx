    ...
    <main className="min-h-screen bg-[#050505] text-white pt-32 pb-32">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col items-center text-center mb-32 relative">
           {/* Linha vertical decorativa (O detalhe que faz a diferença) */}
           ...
           <p className="text-[9px] uppercase tracking-[0.3em] text-zinc-600 max-w-lg leading-relaxed">
             Onde a tradição equestre encontra <br className="hidden md:block"/> a elegância contemporânea
           </p>
        </div>

        {/* GRELHA DE PRODUTOS (Mantivemos o design clean que gostaste) */}
