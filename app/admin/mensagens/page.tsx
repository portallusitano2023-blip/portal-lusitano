                ...
                messages.map((message) => (
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <div className={`mt-1 ${message.status === "novo" ? "text-orange-400" : "text-zinc-600"}`}>
                  ...
                  <div className="bg-zinc-800/50 p-4 rounded-lg space-y-2 text-sm">
                    {selectedMessage.responded_at && (
                      <div className="text-green-400">
                        ...
                        {selectedMessage.responded_by && <span className="text-zinc-500"> por {selectedMessage.responded_by}</span>}
                      </div>
                    )}
