      ...
      <main className="min-h-screen bg-[#050505] text-white pt-32 pb-20 px-6 selection:bg-[#C5A059] selection:text-black">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          {coudelarias.map((item) => (
            <div
              key={item.id}
              className="group relative bg-zinc-900/20 border border-white/5 overflow-hidden hover:border-[#C5A059]/50 transition-all duration-700"
            >
              {/* Imagem */}
              <div className="h-64 w-full overflow-hidden relative">
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <p className="text-[#C5A059] text-[9px] uppercase tracking-widest mb-2">
                    {item.location}
                  </p>
        ...
        <div className="text-center mt-20 border-t border-zinc-900 pt-10">
          <p className="text-zinc-600 text-xs uppercase tracking-widest">
            ...
            <Link
              href="/contacto"
              className="text-[#C5A059] hover:text-white underline underline-offset-4"
            >
              {t.studs.join}
            </Link>
          </p>
